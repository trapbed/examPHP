...
// задание 3
        ...
        function answerForThird($var3) {//функция с атриб.
            ...
            $text_arr = preg_split("//u", $text , -1, PREG_SPLIT_NO_EMPTY);//превращаем текст в массив (//-отсутствие паттерна, u-исп-т кодировку utf-8,преобразуемый тект, не считает пустые элементы)
            $count = 0;//счетчик
                ...
                return[$text, $count];//ф-я возвр. массив из двух переменных
            }
